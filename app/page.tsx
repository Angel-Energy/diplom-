...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Документация проекта</p>
            </div>
          </div>
      ...
      <section className="py-20 px-4 relative">
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-6xl md:text-7xl font-bold mb-6">
            <span className="text-cyan-400">СООБЩЕНИЕ</span> <span className="text-purple-400">404</span>
          </h1>

          <div className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            <span className="text-cyan-300">Текстовый квест</span>
            <span className="text-slate-300"> в жанре </span>
            <span className="text-purple-300">психологического детектива</span>
            <span className="text-slate-300"> для Android</span>
          </div>

          <p className="text-lg text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            Расследуйте корпоративный заговор через интерфейс мессенджера с ветвящимися диалогами и мини-играми на{" "}
            <span className="text-cyan-400 font-semibold">Python/JS</span>
          </p>

          <div className="flex flex-wrap justify-center gap-6 mb-12">
            <div className="bg-slate-800/50 border border-slate-700/50 p-4 rounded-lg hover:border-cyan-500/30 transition-all">
              <div className="flex items-center space-x-3">
                <Zap className="h-6 w-6 text-cyan-400" />
                <span className="text-slate-200 font-medium">60 мини-игр</span>
              </div>
            </div>
            <div className="bg-slate-800/50 border border-slate-700/50 p-4 rounded-lg hover:border-purple-500/30 transition-all">
              <div className="flex items-center space-x-3">
                <Code className="h-6 w-6 text-purple-400" />
                <span className="text-slate-200 font-medium">Kotlin + Compose</span>
              </div>
            </div>
            <div className="bg-slate-800/50 border border-slate-700/50 p-4 rounded-lg hover:border-cyan-500/30 transition-all">
              <div className="flex items-center space-x-3">
                <Shield className="h-6 w-6 text-cyan-400" />
                <span className="text-slate-200 font-medium">Офлайн-режим</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 flex justify-center">
            <Link href="/docs/introduction">
              <Button className="bg-cyan-500/20 border border-cyan-500 text-cyan-400 hover:bg-cyan-500/30 text-lg px-12 py-4">
      ...
      {/* Features Grid */}
      <section className="py-16 px-4 bg-slate-900/30 relative">
        <div className="container mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-cyan-400">СОДЕРЖАНИЕ ДОКУМЕНТАЦИИ</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              return (
                <div
                  key={index}
                  className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-lg hover:border-cyan-500/30 transition-all"
                >
      ...
      {/* Footer */}
      <footer className="border-t border-slate-700/50 bg-slate-900/90 py-8 px-4">
        <div className="container mx-auto text-center">
          <p className="text-slate-400">
            © 2024 СООБЩЕНИЕ 404. ЛИЦЕНЗИЯ MIT.
            <Link href="/docs/legal" className="text-cyan-400 hover:text-cyan-300 ml-2 transition-colors">
              ПОДРОБНЕЕ
            </Link>
          </p>
        </div>

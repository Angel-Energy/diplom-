  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="bg-slate-800/50 border-slate-700/50">
        <CardHeader>
          <CardTitle className="text-white text-center text-2xl">QR коды для быстрой настройки</CardTitle>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="text-center space-y-4">
              ...
              <div className="bg-white p-4 rounded-lg inline-block">
                <img src={wifiQRCode || "/placeholder.svg"} alt="Wi-Fi QR Code" className="w-48 h-48" />
              </div>
            ...
            <div className="text-center space-y-4">
              ...
              <div className="bg-white p-4 rounded-lg inline-block">
                <img src={apkQRCode || "/placeholder.svg"} alt="APK QR Code" className="w-48 h-48" />
              </div>
              <div className="space-y-2">
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-6">
            {setupSteps.map((step, index) => (
              <div key={index} className="flex items-start space-x-4 p-4 bg-slate-900/50 rounded-lg">
